...
const AdminPage = () => {
  ...
  const fetchEntries = async () => {
    try {
      const response = await axios.get('https://r-logistics-77n6.vercel.app/entries');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (isEdit) {
        await axios.put(`https://r-logistics-77n6.vercel.app/edit-entry/${formData._id}`, formData);
        setIsEdit(false);
      } else {
        await axios.post('https://r-logistics-77n6.vercel.app/add-entry', formData);
      }
      setShowForm(false);
      fetchEntries();
      resetForm();
  ...
  const handleDelete = async () => {
    try {
      if (deleteId) {
        await axios.delete(`https://r-logistics-77n6.vercel.app/delete-entry/${deleteId}`);
        fetchEntries();
